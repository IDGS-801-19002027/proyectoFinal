...
from ..models import User, Role, Bitacora, users_roles
...
def addUsers():
    ...
    if request.method=='POST':
        ...
        new_accion = Bitacora(accion = "Nuevo usuario creado", descripcion = "El usuario "+current_user.email+" ha dado de alta al usuario "+str(email))
...
def updateUsers():
    ...
    if request.method=='POST':
        ...
        new_accion = Bitacora(accion = "Usuario modificado", descripcion = "El usuario "+current_user.email+" ha modificado al usuario: "+str(modifUser.email))
        db.session.add(new_accion)
        db.session.commit()
...
def deleteUsers():
    ...
    if request.method=='POST':
        ...
        new_accion = Bitacora(accion = "Usuario eliminado", descripcion = "El usuario "+current_user.email+" ha eliminado al usuario: "+str(usuarioD.email))
        db.session.add(new_accion)
        db.session.commit()
